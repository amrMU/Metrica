            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                <h6 class="panel-title">Browsing Info</h6>
                                <div class="heading-elements">
                                    <span class="label bg-success heading-text"><?php echo e($active_users->count()); ?> active</span>
                                ...
                                <table class="table table-lg text-nowrap">
                                    ...
                                    <tr>
                                        <td class="col-md-10">
                                            ...
                                            <div class="media-left">
                                                <h5 class="text-semibold no-margin">38,289 <small class="text-success text-size-base<i class="icon-arrow-up12"></i> (+16.2%)</small></h5>"><i class="icon-arrow-up12"></i> (+16.2%)</small></h5>
                                        ...
                                        <td class="text-right col-md-2">
                                            <a href="<?php echo e(URL::to('/admin/reports_browsing')); ?>" class="btn bg-indigo-300"><i class="icon-statistics position-left"></i> View report</a>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
