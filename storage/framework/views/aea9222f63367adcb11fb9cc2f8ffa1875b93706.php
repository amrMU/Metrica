                            ...
                            <form class="form-horizontal form-validate-jquery" action="#">
                                <fieldset class="content-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="title_ar" class="form-control" required="required" placeholder="<?php echo app('translator')->getFromJson('home.placeholder_text'); ?>">
                                        </div>
                                    </div>
                                    <!-- /title ar input -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="title_en" class="form-control" required="required" placeholder="<?php echo app('translator')->getFromJson('home.placeholder_text'); ?>">
                                        </div>
                                    </div>
                                    <!-- /title ar input -->
                                 ...
                                 <!-- content ar input -->
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <textarea name="content_ar" class="form-control"  required="required" placeholder="<?php echo app('translator')->getFromJson('home.placeholder_text'); ?>"></textarea>
                                        </div>
                                    </div>
                                    <!-- /content ar input -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9"> 
                                            <textarea name="content_en" class="form-control"  required="required" placeholder="<?php echo app('translator')->getFromJson('home.placeholder_text'); ?>"></textarea>
                                        </div>
                                    </div>
                                    <!-- /content en input -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="meta_tags" class="form-control tokenfield" required="required" value="<?php echo app('translator')->getFromJson('home.placeholder_metatags'); ?>" >
                                        </div>
                                    </div>
                                    <!-- /Meta Tags input -->
                                ...
                                <!-- extirnal code input -->
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <textarea name="extirnal_code" class="form-control"  required="required" placeholder="<?php echo app('translator')->getFromJson('home.placeholder_code'); ?>"></textarea>
                                        </div>
                                    </div>
                                    <!--/extirnal code input -->
                                ...
                                <fieldset class="content-group">
                                    ...
                                    <div class="wrap_emails">
                                        <div class="form-group " >
                                            ...
                                            <div class="col-lg-5">
                                                <input type="email" name="email" class="form-control" id="email" required="required" placeholder="<?php echo app('translator')->getFromJson('home.email'); ?>">
                                            </div>
                                            <div class="col-lg-4">
                                                <input type="text" name="department" class="form-control" id="text" required="required" placeholder="<?php echo app('translator')->getFromJson('home.department'); ?>">
                                            </div>
                                ...
                                <fieldset class="content-group">
                                    ...
                                    <div class="wrap_address">
                                        <div class="form-group " >
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" name="address[]" class="form-control" id="text" required="required" placeholder="<?php echo app('translator')->getFromJson('home.address'); ?>">
                                            </div>
                                ...
                                <fieldset class="content-group">
                                    ...
                                    <div class="wrap_phones">
                                        <div class="form-group " >
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" name="phone[]" class="form-control" id="phone" required="required" placeholder="<?php echo app('translator')->getFromJson('home.phone'); ?>">
                                            </div>
                                ...
                                <fieldset class="content-group">
                                    ...
                                    <div class="wrap_whatsapp">
                                        <div class="form-group " >
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" name="whatsapp[]" class="form-control" id="whatsapp" required="required" placeholder="<?php echo app('translator')->getFromJson('home.whatsapp'); ?>">
                                            </div>
                                ...
                                <fieldset class="content-group">
                                    ...
                                    <div class="wrap_social_media">
                                        <div class="form-group" >
                                            ...
                                            <div class="col-lg-2">
                                                <input type="text" name="title_ar[]" class="form-control" id="text" required="required" placeholder="<?php echo app('translator')->getFromJson('home.name_ar'); ?>" multiple>
                                            </div>
                                            <div class="col-lg-2">
                                                <input type="text" name="title_en[]" class="form-control" id="text" required="required" placeholder="<?php echo app('translator')->getFromJson('home.name_en'); ?>" multiple>
                                            </div>
                                             <div class="col-lg-2">
                                                <input type="text" name="url[]" class="form-control" id="url" required="required" placeholder="<?php echo app('translator')->getFromJson('home.url'); ?>" multiple>
                                            </div>
                                            <div class="col-2">
...
<?php $__env->startSection('jsCode'); ?>
   ...
   $(add_new_email).click(function (e) {
    e.preventDefault();
    $(wrap_emails).append('<div class="form-group" ><label class="control-label col-lg-2"><?php echo app('translator')->getFromJson('home.email'); ?> </label><div class="col-lg-5"><input type="email" name="email" class="form-control" id="email" required="required" placeholder="<?php echo app('translator')->getFromJson('home.email'); ?>"></div><div class="col-lg-4"><input type="text" name="department" class="form-control" id="text" required="required" placeholder="<?php echo app('translator')->getFromJson('home.department'); ?>"></div><div class="col-2  m-10"><button class="remove_field btn btn-danger">-</button></div>'); 
  });
    //start email generator
   ...
   $(add_new_social_media).click(function (e) {
    e.preventDefault();
    $(wrap_social_media).append('<div class="form-group" ><div class="col-lg-2"> <button class="remove_field btn btn-danger">-</button></div><div class="col-lg-2"><input type="text" name="name_ar[]" multiple class="form-control" id="text" required="required" placeholder="<?php echo app('translator')->getFromJson('home.name_ar'); ?>"></div><div class="col-lg-2"><input type="text" name="name_en[]" multiple class="form-control" id="text" required="required" multiple placeholder="<?php echo app('translator')->getFromJson('home.name_en'); ?>"></div><div class="col-lg-2"> <input type="text" name="url[]" multiple class="form-control" id="url" required="required" placeholder="<?php echo app('translator')->getFromJson('home.url'); ?>"></div><div class="col-2"><input type="file" name="social_logo[]"  class="file-styled" required="required" multiple></div></div>'); 
  });
