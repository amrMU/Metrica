                ...
                <div class="sidebar-category sidebar-category-visible">
                    <div class="category-content no-padding">
                        <ul class="navigation navigation-main navigation-accordion">
                            ...
                            <li class="">
									<a href="#" class="has-ul "><i class="icon-users4"></i> <span><?php echo app('translator')->getFromJson('home.categories'); ?></span><span class="legitRipple-ripple" style="left: 39.2308%; top: 63.6364%; transform: translate3d(-50%, -50%, 0px); transition-duration: 0.2s, 0.5s; width: 202.844%;"></span></a>
									<ul class="hidden-ul" style="display: none;">
                                        <li><a href="<?php echo e(URL::to('ar/admin/categories')); ?>" class=""><?php echo app('translator')->getFromJson('home.categories_list'); ?></a></li>
                                        <li><a href="<?php echo e(URL::to('ar/admin/categories/create')); ?>" class="legitRipple"><?php echo app('translator')->getFromJson('home.create_categories'); ?></a></li>
									</ul>
                            </li>
