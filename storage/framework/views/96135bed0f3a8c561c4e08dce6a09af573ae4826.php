...
<head>
  ...
  <?php echo $__env->make('dashboard.layouts.meta_tags_social', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	...
	<script type="text/javascript" src="<?php echo e(asset('/')); ?>assets/js/plugins/tables/datatables/extensions/responsive.min.js"></script>
	...
	<script type="text/javascript" src="<?php echo e(asset('/')); ?>assets/js/pages/datatables_responsive.js"></script>
...
<div class="navbar navbar-inverse bg-indigo">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php echo e(URL::to('/admin/home')); ?>"><img src="<?php echo e(url('/uploads/images/logos'.'/'.str_replace( ' ','_',$setting->title_en).'/org').'/'.@$setting->logo); ?>"  class="img-responsive"></a>
        <?php else: ?>
                ...
                <div class="sidebar-user-material">
                    ...
                    <div class="navigation-wrapper collapse" id="user-nav">
                        <ul class="navigation">
                            ...
                            <!-- <li class="divider"></li> -->
                            <li><a href="<?php echo e(URL::to('admin/setting')); ?>"><i class="icon-cog5"></i> <span><?php echo app('translator')->getFromJson('home.general_settings'); ?></span></a></li>
                ...
                <div class="sidebar-category sidebar-category-visible">
                    <div class="category-content no-padding">
                        <ul class="navigation navigation-main navigation-accordion">
                            ...
                            <li class="active"><a href="<?php echo e(URL::to('admin/home')); ?>"><i class="icon-home4"></i> <span><?php echo app('translator')->getFromJson('home.dashboard'); ?></span></a></li>
                            <li>
