...
<button type="button" class="btn btn-danger " data-toggle="modal" data-target="#DeleteFromList<?php echo e(@$category->id); ?>">
<li class="icon-trash"></li>
</button>


<!-- Modal -->
<div id="DeleteFromList<?php echo e(@$category->id); ?>" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="<?php echo e(URL::to('/admin/categories/').'/'.$category->id.'/delete'); ?>" class="btn btn-danger "> 
