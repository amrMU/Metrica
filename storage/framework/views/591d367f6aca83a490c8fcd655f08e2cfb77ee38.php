                            ...
                            <input name="use" type="hidden" value="<?php echo e(@$info->id); ?>">
                                ...
                                <legend class="text-bold"><?php echo app('translator')->getFromJson('home.add_new_category'); ?></legend>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="title_ar" class="form-control" placeholder="<?php echo app('translator')->getFromJson('home.title_ar'); ?>" value="<?php echo e(@$info->title_ar); ?>">
                                        </div>
                                    </div>
                                    <!-- /title ar input -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="title_en" class="form-control"  placeholder="<?php echo app('translator')->getFromJson('home.title_en'); ?>" value="<?php echo e(@$info->title_en); ?>">
                                        </div>
                                    </div>
                                    <!-- /title ar input -->
                                    <!-- title ar input -->
                                    ...
                                    <!-- /Meta Tags input -->
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                             <textarea name="content_en" id="editor2" rows="4" cols="4"  placeholder="<?php echo app('translator')->getFromJson('home.content_en'); ?>"><?php echo e(@$info->content_en); ?></textarea>
                                        </div>
                                    </div>
