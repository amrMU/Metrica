                ...
                <div class="content">
                    ...
                    <form method="POST" action="<?php echo e(route('password.update')); ?>">
                        ...
                        <div class="panel panel-body login-form">
                            ...
                            <div class="form-group has-feedback">
                                <input  id="password" type="password" class="form-control<?php echo e($errors->has('password_confirmation') ? ' is-invalid' : ''); ?>" name="password_confirmation" value="<?php echo e(old('password_confirmation')); ?>" >
                                <?php if($errors->has('password')): ?>
                                    <span class="invalid-feedback " role="alert">
                            ...
                            <button type="submit" class="btn bg-pink-400 btn-block">    <?php echo e(__('Reset Password')); ?> <i class="icon-arrow-left13 position-right"></i></button>
                        </div>
                    </form>
                    <!-- /password recovery -->
