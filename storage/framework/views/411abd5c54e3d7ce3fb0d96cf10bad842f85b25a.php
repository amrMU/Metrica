                                ...
                                <legend class="text-bold"><?php echo app('translator')->getFromJson('home.add_new_category'); ?></legend>
                                    ...
                                    <label class="control-label col-lg-3"><?php echo app('translator')->getFromJson('home.main_categories'); ?> <span class="text-danger" title="<?php echo app('translator')->getFromJson('home.required'); ?>">*</span></label>
                                        ...
                                        <select name="parent_id" class="form-control" >
                                            ...
                                            <option value="<?php echo e(@$category->id); ?>" <?php if(@$info->parent_id == $category->id): ?> selected <?php endif; ?>><?php echo e((App::isLocale('en')  ? @$category->name_en : @$category->name_ar)); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="name_ar" class="form-control" placeholder="<?php echo app('translator')->getFromJson('home.name_ar'); ?>" value="<?php echo e(@$info->name_ar); ?>">
                                        </div>
                                    </div>
                                    <!-- /title ar input -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="name_en" class="form-control"  placeholder="<?php echo app('translator')->getFromJson('home.name_en'); ?>" value="<?php echo e(@$info->name_en); ?>">
                                        </div>
                                    </div>
                                    <!-- /title ar input -->
                                    <!-- Meta Tags input -->
