                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                ...
                                <div class="heading-elements">
                                    <span class="label bg-success heading-text">{{ $active_users->count() }} active</span>
                                ...
                                <table class="table table-lg text-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right col-md-2">
                                            <a href="{{ URL::to('/admin/reports_browsing') }}" class="btn bg-indigo-300"><i class="icon-statistics position-left"></i> View report</a>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
