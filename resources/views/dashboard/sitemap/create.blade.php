...
<div class="content-wrapper">
    ...
    <div class="page-header page-header-default">
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                <li><a href="{{ URL::to('admin/home') }}"><i class="icon-home2 position-left"></i> Home</a></li>
			...
			<!-- Form validation -->
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							@if(Session::has('file_get'))
							<a class="btn btn-info" href="{{ URL::to('/').'/sitemap/'.Session::get('file_get') }}" target="_blank">DownLoad Now</a>
							@endif
							<form class="form-horizontal form-validate-jquery" action="{{ URL::to('admin/sitemap') }}" method="POST">
								    @csrf
